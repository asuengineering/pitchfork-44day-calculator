...
function starter_plugin_enqueue_block_scripts() {
	...
	wp_register_style ( 'pf-fourtyfour-day-style', plugin_dir_url( __DIR__ ) . 'css/fourtyfour-day.css',  array(), $style_version);
	wp_register_script( 'pf-fourtyfour-day', plugin_dir_url( __DIR__ ) . 'js/fourtyfour-day.js',  array(), $js_version, true);
